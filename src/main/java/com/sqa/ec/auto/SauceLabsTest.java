...
public abstract class SauceLabsTest extends BasicTest
{
	...
	public Object[][] config()
	{
		return new Object[][]
		{ new Object[]
				{ Browser.IE, "11", "Windows 8.1" }, new Object[]
				{ Browser.CHROME, "41", "Windows XP" }, new Object[]
				{ Browser.SAFARI, "7", "OS X 10.9" }, new Object[]
				{ Browser.FIREFOX, "35", "Windows 7" }, new Object[]
				{ Browser.CHROME, "59.0", "OS X 10.9" }, new Object[]
				{ Browser.IE, "11", "Windows 10" }, new Object[]
				{ Browser.FIREFOX, "35", "Windows 10" }, new Object[]
				{ Browser.FIREFOX, "45", "Windows 10" }, new Object[]
				{ Browser.SAFARI, "7", "OS X 10.11.6" } };
	}
	...
	public Object[][] cred()
	{
		return new Object[][]
		{ new Object[]
				{ getProp("sl-user"), getProp("sl-key") } };
	}
	...
	public void preTest(String username, String accessKey, Browser browser, String version, String platform) throws BrowserNotSupportedBySauceLabsException
	{
		this.user = username;
	...
	public WebDriver setupSpecDriver() throws BrowserNotSupportedBySauceLabsException
	{
		...
		{
			System.out.println("Can connect to Sauce Labs URL: {" + "http://" + getUser() + ":" + getAccessKey() + "@ondemand.saucelabs.com:80/wd/hub)");
		}
		switch (this.browser)
		{
		case CHROME:
		...
		String testName = getClass().getSimpleName() + " within the browser " + this.browser.toString().toLowerCase() + ", running on OS-" + this.platform;
